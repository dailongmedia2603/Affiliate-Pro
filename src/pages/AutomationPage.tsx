...
const AutomationPage = () => {
  ...
  const handleConfigure = (channelId: string) => {
    // Logic for Phase 2
    alert(`Cấu hình cho kênh ${channelId} sẽ được triển khai ở giai đoạn sau.`);
  };
            ...
            filteredChannels.map(channel => (
              ...
              >
                ...
                <div className="flex items-center justify-end gap-2 mt-3">
                  <Button variant="outline" size="sm" onClick={(e) => { e.stopPropagation(); handleConfigure(channel.id); }}>
